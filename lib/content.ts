...
export const profile = {
  ...
  about: [
    "I dropped out of college and moved to San Francisco, a city I had never once set foot in. Not because I was lost, but because I could see where everything was heading and I refused to miss it. The lecture halls were not the fastest road to where I wanted to go, so I stopped waiting for a future to be handed to me and came out here to grab it with my own hands. There is too much happening right now to sit still.",
