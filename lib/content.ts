...
export const projects: readonly Project[] = [
  ...
  { slug: "launch-control", name: "Launch Control", status: "open-source", year: "2026",
    ...
    shot: "/shots/launch-control.jpg",
    shotAlt: "Launch Control app: the launch composer with a crew of Claude agents, a strategist, channel writers, and a critic, planning a week of content" },
