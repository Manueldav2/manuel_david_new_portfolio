...
export type BrandName = "x" | "linkedin" | "github"

// Official current brand marks, drawn as single filled glyphs on a 24×24 grid.
// fill=currentColor so they inherit text color; aria-hidden since the link text
// (or aria-label on the anchor) carries the accessible name.
...
export function BrandIcon({ name, size = 20, className, ...rest }: BrandIconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      width={size}
